...
public class TergabungKelasAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TergabungKelasAdapter(List<Enrollment> kelasList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (getItemViewType(i) == TYPE_LIST){
            ...
            listHolder.status.setText("Telah Tergabung");
