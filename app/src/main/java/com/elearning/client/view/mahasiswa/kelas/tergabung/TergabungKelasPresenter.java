...
public class TergabungKelasPresenter {

    TergabungKelasView view;
    ApiInterface apiInterface;
    CompositeDisposable disposable;

    public TergabungKelasPresenter(TergabungKelasView view) {
        this.view = view;
    ...
    public void getKelas(String token,String id, Integer page) {
        view.showProgress();
        disposable.add(
                apiInterface.getAllEnrollMahasiswa(token ,id,true,page, 10)
