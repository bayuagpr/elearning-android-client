package com.elearning.client.view.dosen;
...
public class MainDosenActivity extends BaseActivity
...
//            startActivity(new Intent(MainDosenActivity.this, SearchActivity.class));
//        }
