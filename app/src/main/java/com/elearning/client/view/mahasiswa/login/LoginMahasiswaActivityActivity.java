...
public class LoginMahasiswaActivityActivity extends BaseLoginActivity implements  Validator.ValidationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSignUp.setOnClickListener(v -> {
            Intent intentDosen = new Intent(LoginMahasiswaActivityActivity.this, SignupMahasiswaActivityActivity.class);
    ...
    public void onBackPressed(){
        Intent intentDosen = new Intent(LoginMahasiswaActivityActivity.this, AuthStartActivityActivity.class);
        startActivity(intentDosen);
    }

    @Override
    public void onValidationSucceeded() {
        Intent intentDosen = new Intent(LoginMahasiswaActivityActivity.this, MainActivity.class);
        startActivity(intentDosen);
    }
